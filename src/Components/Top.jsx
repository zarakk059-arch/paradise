...
const Top = () => {
  return (
    <div className="w-full flex items-center px-10 py-4 mt-3">
      ...
      <div className="hidden md:flex items-center gap-10 lg:gap-19 ml-10 lg:ml-40">
        <div className="flex items-center gap-3 lg:gap-5">
          <IoLocationOutline className="text-xl lg:text-2xl text-pink-400" />
          <div>
        ...
        <div className="flex items-center gap-3 lg:gap-5">
          <RiMailCheckLine className="text-xl lg:text-2xl text-blue-400" />
        ...
        <button className="px-5 lg:px-7 py-2 lg:py-3 rounded-xl text-white font-semibold bg-linear-to-r from-pink-300 to-blue-300 hover:opacity-90 transition text-sm lg:text-base whitespace-nowrap">
          MAKE AN APPOINTMENT
        </button>
      </div>
    </div>
